...
import com.example.caffeine.composable.BackButtonHeader
import com.example.caffeine.composable.CoffeeSelector
import com.example.caffeine.composable.CupSize
import com.example.caffeine.composable.IconTextButton
import com.example.caffeine.composable.SizeSelector
...
fun SizedProductScreen(
    navController: NavController, viewModel: SizedProductScreenViewModel = viewModel()
) {
    ...
    SizedProductContent(
        ...
        onNextClicked = {
            navController.navigate(AppDestination.PrepareProgressScreen.route)
        })
}
